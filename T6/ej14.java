	...
	public static void main(String[] args) {
		...
		do{
			System.out.print("¿Que número crees que es?: ");
				...
				if(num<aleatorio) {
					intentos--;
					System.out.println("El número es mayor que el que has dicho, quedan "+intentos+" intentos");
				}
				
				if(num>aleatorio) {
					intentos--;
					System.out.println("El número es menor que el que has dicho, quedan "+intentos+" intentos");
				}
